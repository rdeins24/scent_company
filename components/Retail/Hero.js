...
import img from '../../public/assets/retail/store.jpg'
import img1 from '../../public/assets/retail/store1.jpg'
import img2 from '../../public/assets/retail/store2.jpg'
...
const HeroSection = () => {
    return (
        <div className="flex flex-col-reverse md:flex-row h-screen">
          {/* Left Text Block */}
          <div className="md:w-1/2 bg-[#523D35] flex flex-col justify-center p-10">
