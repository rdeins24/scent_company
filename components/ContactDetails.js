...
function ContactDetails() {
  return (
    <section className="text-gray-600 body-font max-w-6xl mx-auto pt-[50px]">
            ...
            <ul>
              <li>
                <Link href="mailto:info@scentiomilano.com" legacyBehavior>
                  <a className="text-gray-500 font-medium text-base hover:text-blue-600 block w-full py-2">
